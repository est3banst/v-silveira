...
const Footer = () => {
    ...
    return (
        <>
            ...
            <footer className='text-slate-800 h-auto flex-col justify-center md:flex-row px-4 my-4 py-4 flex gap-2 md:items-center md:justify-evenly'>
                <div className='p-2 flex flex-col items-center'>
                    ...
                    <a href=""
                        ...
                        <img
                            className='w-[48px]'
                            src="dent-checkup.png" alt="Sintonia dental icono" />
                ...
                <div className='py-3'>
                    ...
                    <ol>
                        ...
                        <li className='relative'>
                            <button
                                className='bg-transparent p-2 hover:bg-teal-100'
                ...
                <div className='py-3'>
                    ...
                    <section className='flex items-center py-2 gap-2'>
                        ...
                        <p>Juan Paullier 123 esq. La Paz , Montevideo</p>
                    </section>
                </div>
            ...
            <div className='flex gap-4 justify-center text-xs p-4'>
